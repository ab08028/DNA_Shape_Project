...
outdir="/Users/annabelbeichman/Documents/UW/DNAShapeProject/results/modeling/experiments/20210713_model_015_modelingUnseen7mers.LeaveOutSameSetBothSpp_ranOnLaptop/"
...
#last_rf_fit <- readRDS(paste0(outdir,"FitOfFullModelToHeldOut7mers.rds"))
...
### aggregate over 5mers?
head(predictions_withData_spread)
predictions_withData_spread$central5mer <- paste0(substr(predictions_withData_spread$mutationType,2,6),".",substr(predictions_withData_spread$mutationType,11,15))
head()
predictions_withData_spread %>% 
  group_by()
