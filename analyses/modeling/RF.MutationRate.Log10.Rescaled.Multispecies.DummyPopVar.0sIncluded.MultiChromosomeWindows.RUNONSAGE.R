...
rand_forest_processing_recipe <- 
  ...
  step_rm(derived7mer,ancestral7mer, mutationCount,mutationCount_divByTargetCount,mutationCount_divByTargetCount_plusEpsilon,mutationCount_divByTargetCount_plusEpsilon_RESCALED,newGroup,label,ancestral7merCount) %>%
