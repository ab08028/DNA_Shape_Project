...
outdir="/Users/annabelbeichman/Documents/UW/DNAShapeProject/results/modeling/experiments/20210713_model_016_modelingUnseen7mers.LeaveOut50percentAndMin_N5ToSeeIfPerformanceDrops_ranOnLaptop/"
...
training1Species <- allData_withShapes_unprocessed %>%
  ...
  sample_frac(0.5) %>% ### NOTE REDUCTION HERE
