...
vcffilename="Pan_troglodytes.bcf" # chimp only: a bcf file from Michael. note this whole genome; but Michael's anc fasta are per chrom so i am subsetting this vcf into chrs when it's processed
...
ancestralFastafilename="Pan_troglodytes_chr${interval}.fa" # made by Michael
chrom_pos=0 # 0-based position of chr name in fasta (e.g. >chr1 blahlbah blahblah)

########### individuals to exclude ############
individualsToExclude='Pan_troglodytes_ellioti-Banyo'
# excluded due to bad qual
