...
#### note for vaquita: need to make sure targets file of fasta is just autosomes 
# for targets for reference genomes: need to restrict to just main chromosomes 
# think about what would make adding in another species (eg wolves) easy. 
