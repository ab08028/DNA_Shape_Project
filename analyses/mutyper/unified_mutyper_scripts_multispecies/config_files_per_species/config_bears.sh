...
ancestralFastaDir="/net/harris/vol1/home/beichman/bears/analyses/ancestralReferenceFastas/brown_bear/interval_${interval}/"
ancestralFastafilename="MODIFIED.ANCESTRAL.brown_bear.interval_${interval}.fasta"
