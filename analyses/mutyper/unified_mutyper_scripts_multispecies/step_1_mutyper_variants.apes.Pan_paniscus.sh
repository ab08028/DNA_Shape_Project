...
#$ -N Pan_paniscus_mutypervariants
...
# pan paniscus doesn't need anything special (not removing any inds), except as all apes: need to jump to right chr
######################## pan paniscus ################
...
species=apes_Pan_paniscus


vcfdir=/net/harris/vol1/data/great_ape_genome_project/eichlerlab.gs.washington.edu/greatape/data/VCFs/SNPs

vcffilename=Pan_paniscus.vcf.gz

# apes have own anc ref genomes made by Michael Goldberg 
ancestralFastafilename=/net/harris/vol1/home/beichman/apes/polarized_ref_fastas/hg18_references_with_gagp_ancestral_alleles_exclude_recurrent/Pan_paniscus_${intervallabel}.fa
