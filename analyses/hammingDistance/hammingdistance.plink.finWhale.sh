...
interval=`printf "%02d\n" ${SGE_TASK_ID}` # prepend 0 to interval number
...
vcfdir=/net/harris/vol1/home/beichman/fin_whale/analyses/mutyper/downloaddate_20211015_whole_genomes_plusOutgroups/mutyperResults_20211029_NOSTRICT_CALLABLESITESONLY_POLARIZED_7mer/mutyper_variant_files/interval_${interval}
...
vcf=$vcfdir/allInds_interval_${interval}.mutyper.variants.mutationTypes.noMissingData.noFixedSites.AncestralDerivedNotRefAlt.SomeRevComped.NOSTRICT.WHOLEGENOME.PASSSITES.POLARIZED.ALLFREQS.vcf.gz
