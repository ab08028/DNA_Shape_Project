...
sigprofilerRunLabel="20210816_SigProfilerExtractorResults_bearsMice_kSFSAllFreqsSep_mm10GenomeRef"
...
# TEMPORARY: denovoSBSCounts <- read.table("/Users/annabelbeichman/Documents/UW/DNAShapeProject/results/SigProfilerExtractor/20210809_SigProfilerExtractorResults_bears_kSFSAllFreqsSep_GRCh37GenomeRef/SBS96/All_Solutions/SBS96_5_Signatures/Activities/SBS96_S5_NMF_Activities.txt",header=T)
