...
require(tidyverse)
require(reshape2)
wd="/Users/annabelbeichman/Documents/UW/DNAShapeProject/results/SigProfilerExtractor/20210816_SigProfilerExtractorResults_bearsMice_kSFSAllFreqsSep_mm10GenomeRef/SBS96/"
...
plot5_denovo <- ggplot(denovo_combined_summed_OverSignatures,aes(x=alleleFrequency,y=proportionOfSites,color=species,group=species,linetype="sigprofilerextractor"))+
  ...
  theme_bw()
plot5_denovo
ggsave(paste0(plotdir,"model.MutationsContributedPerCentralType.allSigsCombined.alleleFreqs.WITHEMPIRICAL.DeNovoOnly.NoCosmicDecomposition.facetedPerSpp.png"),plot5_denovo,width=18,height=16)
