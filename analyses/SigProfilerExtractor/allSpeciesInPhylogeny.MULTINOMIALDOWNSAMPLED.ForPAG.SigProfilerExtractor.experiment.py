...
# note the formatting for these species was done within my large script: "projected spectra plus hamming " etc
...
wd="/Users/annabelbeichman/Documents/UW/DNAShapeProject/results/comparing_spectrum_and_phylo_divergence_WITHPROJECTIONS/20211213.plots.projectedCounts.epsilon.1.sepCpGs.no.addingApes_maskedMouseVaq.addingMultinomialDownsampling.MorePlotsForPAG/SigProfilerExtractorFiles/"
matrixFile=wd+"AllSpecies.All_Intervals_Counts.perPopulation.SAMPLESIZECORRECTED.MULTINOMIALDOWNSAMPLED.COUNTS.CentralAsRevCompedToTs.SIGPROFILEREXTRACTORFORMAT.txt"
# https://osf.io/t6j7u/wiki/2.%20Quick%20Start%20Example/
label="allSpeciesPopulations__"+reference_genome+"GenomeRef"
outdir=wd
