...
matrixFile="/Users/annabelbeichman/Documents/UW/DNAShapeProject/results/SigProfilerExtractor/input_data/20210805MultispeciesMatrix.Mouse.Bear.Vaquita.FinWhale.BulkCetaceans.txt"
# https://osf.io/t6j7u/wiki/2.%20Quick%20Start%20Example/

normchoice="100X"
label=normchoice+"norm_bearsMiceVaquitaFinWhaleBulkCetaceans_"+reference_genome+"GenomeRef"
...
sig.sigProfilerExtractor(input_type="matrix",output=outdir, input_data=matrixFile, reference_genome= reference_genome, minimum_signatures=1, maximum_signatures=10, nmf_replicates=500, cpu=-1,matrix_normalization=normchoice)
