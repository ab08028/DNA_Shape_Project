...
indir="/Users/annabelbeichman/Documents/UW/WhaleProject/vaquita/results/mutyper/bulk_cetaceans/mutyperResults_20210927_3mer_NOSTRICT/mutyper_spectrum_files/" # 20211005 -- new 3mers for cetaceans with no --strict and callable sites masking of targets.

outdir="/Users/annabelbeichman/Documents/UW/WhaleProject/vaquita/results/mutyper/bulk_cetaceans/mutyperResults_20210927_3mer_NOSTRICT/summaryTables/"
dir.create(outdir)
...
# 
write.table(allSpectra_wider,paste0(outdir,"bulkCetaceans.All_Intervals_Counts.HetsOnly.PerIndividual.nostrict.CentralAsRevCompedToTs.SIGPROFILEREXTRACTORFORMAT.usethis.txt"),row.names=F,quote=F,sep="\t")
